...
void PETScJacobiSolver::create_shell_mat() {
  throw std::runtime_error("PETScJacobiSolver::create_shell_mat not implemented for HIP yet");
  /*
  if(pMatInit)
    MatDestroy(&pMat);
...
void PETScJacobiSolver::set_shell_pc(PC pc) {
  throw std::runtime_error("PETScJacobiSolver::set_shell_pc not implemented for HIP yet");
  /*
