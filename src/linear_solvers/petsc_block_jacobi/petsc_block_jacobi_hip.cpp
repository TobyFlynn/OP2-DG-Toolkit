...
void PETScBlockJacobiSolver::create_shell_mat() {
  throw std::runtime_error("PETScBlockJacobiSolver::create_shell_mat not implemented for HIP yet");
  /*
  if(pMatInit)
    MatDestroy(&pMat);
...
void PETScBlockJacobiSolver::set_shell_pc(PC pc) {
  throw std::runtime_error("PETScBlockJacobiSolver::set_shell_pc not implemented for HIP yet");
  /*
