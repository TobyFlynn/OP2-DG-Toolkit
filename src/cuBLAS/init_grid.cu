...
inline void cublas_init_grid(cublasHandle_t handle, const int numCells,
  ...
  double alpha2 = 1.0;
  double beta = 0.0;
  cublasDgemm(handle, CUBLAS_OP_T, CUBLAS_OP_N, DG_NP, numCells, DG_NP, &alpha2, constants->Dr_d, DG_NP, x_d, DG_NP, &beta, xr_d, DG_NP);
  cublasDgemm(handle, CUBLAS_OP_T, CUBLAS_OP_N, DG_NP, numCells, DG_NP, &alpha2, constants->Ds_d, DG_NP, x_d, DG_NP, &beta, xs_d, DG_NP);
  cublasDgemm(handle, CUBLAS_OP_T, CUBLAS_OP_N, DG_NP, numCells, DG_NP, &alpha2, constants->Dr_d, DG_NP, y_d, DG_NP, &beta, yr_d, DG_NP);
  cublasDgemm(handle, CUBLAS_OP_T, CUBLAS_OP_N, DG_NP, numCells, DG_NP, &alpha2, constants->Ds_d, DG_NP, y_d, DG_NP, &beta, ys_d, DG_NP);
