...
inline void openblas_init_gauss(const int numCells, const double *x,
  ...
  cblas_dgemm(CblasColMajor, CblasTrans, CblasTrans, DG_GF_NP, DG_NP, DG_NP, 1.0, constants->gFInterp0, DG_NP, constants->Dr, DG_NP, 0.0, dVMdr_f0, DG_GF_NP);
  cblas_dgemm(CblasColMajor, CblasTrans, CblasTrans, DG_GF_NP, DG_NP, DG_NP, 1.0, constants->gFInterp1, DG_NP, constants->Dr, DG_NP, 0.0, dVMdr_f1, DG_GF_NP);
  cblas_dgemm(CblasColMajor, CblasTrans, CblasTrans, DG_GF_NP, DG_NP, DG_NP, 1.0, constants->gFInterp2, DG_NP, constants->Dr, DG_NP, 0.0, dVMdr_f2, DG_GF_NP);
  cblas_dgemm(CblasColMajor, CblasTrans, CblasTrans, DG_GF_NP, DG_NP, DG_NP, 1.0, constants->gFInterp0, DG_NP, constants->Ds, DG_NP, 0.0, dVMds_f0, DG_GF_NP);
  cblas_dgemm(CblasColMajor, CblasTrans, CblasTrans, DG_GF_NP, DG_NP, DG_NP, 1.0, constants->gFInterp1, DG_NP, constants->Ds, DG_NP, 0.0, dVMds_f1, DG_GF_NP);
  cblas_dgemm(CblasColMajor, CblasTrans, CblasTrans, DG_GF_NP, DG_NP, DG_NP, 1.0, constants->gFInterp2, DG_NP, constants->Ds, DG_NP, 0.0, dVMds_f2, DG_GF_NP);
