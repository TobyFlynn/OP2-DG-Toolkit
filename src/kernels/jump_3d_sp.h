inline void jump_3d_sp(const int * __restrict__ order, const int * __restrict__ faceNum, const int * __restrict__ fmaskL_corrected,
                    const int * __restrict__ fmaskR_corrected, const float ** __restrict__ in, float ** __restrict__ out) {
  const int p = *order;
