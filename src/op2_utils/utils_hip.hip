...
DG_FP *getOP2PtrDevice(op_dat dat, op_access acc) {
  throw std::runtime_error("getOP2PtrDevice not implemented for HIP yet");
  return nullptr;
  /*
  op_arg args[] = {
...
void releaseOP2PtrDevice(op_dat dat, op_access acc, const DG_FP *ptr) {
  throw std::runtime_error("releaseOP2PtrDevice not implemented for HIP yet");
  /*
  op_arg args[] = {
    op_arg_dat(dat, -1, OP_ID, dat->dim, DG_FP_STR, acc)
  };
...
DG_FP *getOP2PtrHost(op_dat dat, op_access acc) {
  throw std::runtime_error("getOP2PtrHost not implemented for HIP yet");
  return nullptr;
  /*
  op_arg args[] = {
    op_arg_dat(dat, -1, OP_ID, dat->dim, DG_FP_STR, acc)
...
void releaseOP2PtrHost(op_dat dat, op_access acc, const DG_FP *ptr) {
  throw std::runtime_error("releaseOP2PtrHost not implemented for HIP yet");
  /*
  op_arg args[] = {
    op_arg_dat(dat, -1, OP_ID, dat->dim, DG_FP_STR, acc)
  };
...
DG_FP *getOP2PtrDeviceHE(op_dat dat, op_access acc) {
  throw std::runtime_error("getOP2PtrDeviceHE not implemented for HIP yet");
  return nullptr;
  /*
  op_arg args[] = {
    op_arg_dat(dat, -1, OP_ID, dat->dim, DG_FP_STR, acc),
...
void releaseOP2PtrDeviceHE(op_dat dat, op_access acc, const DG_FP *ptr) {
  throw std::runtime_error("releaseOP2PtrDeviceHE not implemented for HIP yet");
  /*
  op_arg args[] = {
    op_arg_dat(dat, -1, OP_ID, dat->dim, DG_FP_STR, acc),
  };
...
DG_FP *getOP2PtrHostHE(op_dat dat, op_access acc) {
  throw std::runtime_error("getOP2PtrHostHE not implemented for HIP yet");
  return nullptr;
  /*
  op_arg args[] = {
    op_arg_dat(dat, -1, OP_ID, dat->dim, DG_FP_STR, acc)
...
float *getOP2PtrHostSP(op_dat dat, op_access acc) {
  throw std::runtime_error("getOP2PtrHostSP not implemented for HIP yet");
  return nullptr;
...
void releaseOP2PtrHostSP(op_dat dat, op_access acc, const float *ptr) {
  throw std::runtime_error("releaseOP2PtrHostSP not implemented for HIP yet");
  /*
  op_arg args[] = {
    op_arg_dat(dat, -1, OP_ID, dat->dim, "float", acc)
  };
