...
//user function
__device__ void gemv_ds_gpu( const int *p, const bool *t, const double *alpha,
...
__global__ void op_cuda_gemv_ds(
...
//host stub function
void op_par_loop_gemv_ds(char const *name, op_set set,
  op_arg arg0,
  op_arg arg1,
  op_arg arg2,
  op_arg arg3,
  ...
  if (OP_diags>2) {
    printf(" kernel routine w/o indirection:  gemv_ds");
  }
  ...
  if (set_size > 0) {
    ...
    op_cuda_gemv_ds<<<nblocks,nthread>>>(
      (int *) arg0.data_d,
      (bool *) arg1.data_d,
      (double *) arg2.data_d,
      (double *) arg3.data_d,
