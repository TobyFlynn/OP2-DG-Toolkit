...
//user function
__device__ void gemv_inv_mass_gpu( const int *p, const bool *t, const double *alpha,
...
__global__ void op_cuda_gemv_inv_mass(
...
void op_par_loop_gemv_inv_mass(char const *name, op_set set,
  ...
  if (set_size > 0) {
    ...
    op_cuda_gemv_inv_mass<<<nblocks,nthread>>>(
      (int *) arg0.data_d,
      (bool *) arg1.data_d,
      (double *) arg2.data_d,
      (double *) arg3.data_d,
