...
void DGConstants3D::transfer_kernel_ptrs() {
  ...
  cutilSafeCall(cudaMemcpyToSymbol(dg_t_kernel, &dg_t_d, sizeof(dg_r_d)));
  ...
  cutilSafeCall(cudaMemcpyToSymbol(dg_Dt_kernel, &dg_mats.at(DT)->mat_ptr_dp_device, sizeof(dg_r_d)));
  ...
  cutilSafeCall(cudaMemcpyToSymbol(dg_Dtw_kernel, &dg_mats.at(DTW)->mat_ptr_dp_device, sizeof(dg_r_d)));
  ...
  cutilSafeCall(cudaMemcpyToSymbol(dg_MM_F3_kernel, &dg_mats.at(MM_F3)->mat_ptr_dp_device, sizeof(dg_r_d)));
  ...
  cutilSafeCall(cudaMemcpyToSymbol(dg_cub3d_Interp_kernel, &dg_mats.at(CUB3D_INTERP)->mat_ptr_dp_device, sizeof(dg_r_d)));
  cutilSafeCall(cudaMemcpyToSymbol(dg_cub3d_Proj_kernel, &dg_mats.at(CUB3D_PROJ)->mat_ptr_dp_device, sizeof(dg_r_d)));
  cutilSafeCall(cudaMemcpyToSymbol(dg_cub3d_PDr_kernel, &dg_mats.at(CUB3D_PDR)->mat_ptr_dp_device, sizeof(dg_r_d)));
  cutilSafeCall(cudaMemcpyToSymbol(dg_cub3d_PDs_kernel, &dg_mats.at(CUB3D_PDS)->mat_ptr_dp_device, sizeof(dg_r_d)));
  cutilSafeCall(cudaMemcpyToSymbol(dg_cub3d_PDt_kernel, &dg_mats.at(CUB3D_PDT)->mat_ptr_dp_device, sizeof(dg_r_d)));
  cutilSafeCall(cudaMemcpyToSymbol(dg_cubSurf3d_Interp_kernel, &dg_mats.at(CUBSURF3D_INTERP)->mat_ptr_dp_device, sizeof(dg_r_d)));
  cutilSafeCall(cudaMemcpyToSymbol(dg_cubSurf3d_Lift_kernel, &dg_mats.at(CUBSURF3D_LIFT)->mat_ptr_dp_device, sizeof(dg_r_d)));
