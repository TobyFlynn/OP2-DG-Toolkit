...
DG_FP *dg_cubSurf3d_Interp_d;
DG_FP *dg_cubSurf3d_Lift_d;
...
void DGConstants3D::transfer_kernel_ptrs() {
  ...
  cutilSafeCall(cudaMalloc(&dg_cubSurf3d_Interp_d, DG_NUM_FACES * DG_NPF * DG_NUM_FACES * DG_CUB_SURF_3D_NP * sizeof(DG_FP)));
  cutilSafeCall(cudaMalloc(&dg_cubSurf3d_Lift_d, DG_NP * DG_NUM_FACES * DG_CUB_SURF_3D_NP * sizeof(DG_FP)));
  ...
  cutilSafeCall(cudaMemcpy(dg_cubSurf3d_Interp_d, cubInterpSurf_ptr, DG_NUM_FACES * DG_NPF * DG_NUM_FACES * DG_CUB_SURF_3D_NP * sizeof(DG_FP), cudaMemcpyHostToDevice));
  cutilSafeCall(cudaMemcpy(dg_cubSurf3d_Lift_d, cubLiftSurf_ptr, DG_NP * DG_NUM_FACES * DG_CUB_SURF_3D_NP * sizeof(DG_FP), cudaMemcpyHostToDevice));
  ...
  cutilSafeCall(cudaMemcpyToSymbol(dg_cubSurf3d_Interp_kernel, &dg_cubSurf3d_Interp_d, sizeof(dg_cubSurf3d_Interp_d)));
  cutilSafeCall(cudaMemcpyToSymbol(dg_cubSurf3d_Lift_kernel, &dg_cubSurf3d_Lift_d, sizeof(dg_cubSurf3d_Lift_d)));
  ...
  cutilSafeCall(cudaMalloc(&dg_cubInterp_sp_d, DG_NP * DG_CUB_3D_NP * sizeof(float)));
  cutilSafeCall(cudaMalloc(&dg_cubProj_sp_d, DG_NP * DG_CUB_3D_NP * sizeof(float)));
  cutilSafeCall(cudaMalloc(&dg_cubPDrT_sp_d, DG_NP * DG_CUB_3D_NP * sizeof(float)));
  cutilSafeCall(cudaMalloc(&dg_cubPDsT_sp_d, DG_NP * DG_CUB_3D_NP * sizeof(float)));
  cutilSafeCall(cudaMalloc(&dg_cubPDtT_sp_d, DG_NP * DG_CUB_3D_NP * sizeof(float)));
  cutilSafeCall(cudaMalloc(&dg_cubInterpSurf_sp_d, DG_NUM_FACES * DG_NPF * DG_NUM_FACES * DG_CUB_SURF_3D_NP * sizeof(float)));
  cutilSafeCall(cudaMalloc(&dg_cubLiftSurf_sp_d, DG_NP * DG_NUM_FACES * DG_CUB_SURF_3D_NP * sizeof(float)));
  ...
  cutilSafeCall(cudaMemcpy(dg_cubInterp_sp_d, cubInterp_ptr_sp, DG_NP * DG_CUB_3D_NP * sizeof(float), cudaMemcpyHostToDevice));
  cutilSafeCall(cudaMemcpy(dg_cubProj_sp_d, cubProj_ptr_sp, DG_NP * DG_CUB_3D_NP * sizeof(float), cudaMemcpyHostToDevice));
  cutilSafeCall(cudaMemcpy(dg_cubPDrT_sp_d, cubPDrT_ptr_sp, DG_NP * DG_CUB_3D_NP * sizeof(float), cudaMemcpyHostToDevice));
  cutilSafeCall(cudaMemcpy(dg_cubPDsT_sp_d, cubPDsT_ptr_sp, DG_NP * DG_CUB_3D_NP * sizeof(float), cudaMemcpyHostToDevice));
  cutilSafeCall(cudaMemcpy(dg_cubPDtT_sp_d, cubPDtT_ptr_sp, DG_NP * DG_CUB_3D_NP * sizeof(float), cudaMemcpyHostToDevice));
  cutilSafeCall(cudaMemcpy(dg_cubInterpSurf_sp_d, cubInterpSurf_ptr_sp, DG_NUM_FACES * DG_NPF * DG_NUM_FACES * DG_CUB_SURF_3D_NP * sizeof(float), cudaMemcpyHostToDevice));
  cutilSafeCall(cudaMemcpy(dg_cubLiftSurf_sp_d, cubLiftSurf_ptr_sp, DG_NP * DG_NUM_FACES * DG_CUB_SURF_3D_NP * sizeof(float), cudaMemcpyHostToDevice));
}
...
void DGConstants3D::clean_up_kernel_ptrs() {
  ...
  cudaFree(dg_cubSurf3d_Interp_d);
  cudaFree(dg_cubSurf3d_Lift_d);
...
DG_FP* DGConstants3D::get_mat_ptr_device(Constant_Matrix matrix) {
  switch(matrix) {
    ...
    case CUBSURF3D_INTERP:
      return dg_cubSurf3d_Interp_d;
    case CUBSURF3D_LIFT:
      return dg_cubSurf3d_Lift_d;
    default:
