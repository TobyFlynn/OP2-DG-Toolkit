...
void DGConstants3D::transfer_kernel_ptrs() {
  throw std::runtime_error("DGConstants3D::transfer_kernel_ptrs not implemented for HIP yet");
  /*
...
void DGConstants3D::clean_up_kernel_ptrs() {
  throw std::runtime_error("DGConstants3D::clean_up_kernel_ptrs not implemented for HIP yet");
  /*
  cudaFree(dg_r_d);
  cudaFree(dg_s_d);
  cudaFree(dg_t_d);
...
DG_FP* DGConstants3D::get_mat_ptr_kernel(Constant_Matrix matrix) {
  throw std::runtime_error("DGConstants3D::get_mat_ptr_kernel not implemented for HIP yet");
  /*
  switch(matrix) {
    case R:
      return dg_r_d;
...
float* DGConstants3D::get_mat_ptr_kernel_sp(Constant_Matrix matrix) {
  throw std::runtime_error("DGConstants3D::get_mat_ptr_kernel_sp not implemented for HIP yet");
  /*
  switch(matrix) {
    case DR:
      return dg_Dr_sp_d;
