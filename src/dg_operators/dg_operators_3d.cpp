...
void DGMesh3D::grad(op_dat u, op_dat ux, op_dat uy, op_dat uz) {
  ...
  op_par_loop(grad_3d, "grad_3d", cells,
              ...
              op_arg_dat(rx, -1, OP_ID, 1, "double", OP_READ),
              op_arg_dat(sx, -1, OP_ID, 1, "double", OP_READ),
              op_arg_dat(tx, -1, OP_ID, 1, "double", OP_READ),
              op_arg_dat(ry, -1, OP_ID, 1, "double", OP_READ),
              op_arg_dat(sy, -1, OP_ID, 1, "double", OP_READ),
              op_arg_dat(ty, -1, OP_ID, 1, "double", OP_READ),
              op_arg_dat(rz, -1, OP_ID, 1, "double", OP_READ),
              op_arg_dat(sz, -1, OP_ID, 1, "double", OP_READ),
              op_arg_dat(tz, -1, OP_ID, 1, "double", OP_READ),
              op_arg_dat(ux, -1, OP_ID, DG_NP, "double", OP_WRITE),
              op_arg_dat(uy, -1, OP_ID, DG_NP, "double", OP_WRITE),
              op_arg_dat(uz, -1, OP_ID, DG_NP, "double", OP_WRITE));
}
...
void DGMesh3D::grad_with_central_flux(op_dat u, op_dat ux, op_dat uy, op_dat uz) {
  ...
  op_par_loop(zero_npf, "zero_npf", cells,
              op_arg_dat(op_tmp_npf[0], -1, OP_ID, DG_NUM_FACES * DG_NPF, "double", OP_WRITE));
  op_par_loop(zero_npf, "zero_npf", cells,
              op_arg_dat(op_tmp_npf[1], -1, OP_ID, DG_NUM_FACES * DG_NPF, "double", OP_WRITE));
  op_par_loop(zero_npf, "zero_npf", cells,
              op_arg_dat(op_tmp_npf[2], -1, OP_ID, DG_NUM_FACES * DG_NPF, "double", OP_WRITE));
  ...
  op_par_loop(grad_3d_central_flux, "grad_3d_central_flux", faces,
              ...
              op_arg_dat(nx, -1, OP_ID, 2, "double", OP_READ),
              op_arg_dat(ny, -1, OP_ID, 2, "double", OP_READ),
              op_arg_dat(nz, -1, OP_ID, 2, "double", OP_READ),
              op_arg_dat(fscale, -1, OP_ID, 2, "double", OP_READ),
              op_arg_dat(u, -2, face2cells, DG_NP, "double", OP_READ),
              op_arg_dat(op_tmp_npf[0], -2, face2cells, DG_NUM_FACES * DG_NPF, "double", OP_INC),
              op_arg_dat(op_tmp_npf[1], -2, face2cells, DG_NUM_FACES * DG_NPF, "double", OP_INC),
              op_arg_dat(op_tmp_npf[2], -2, face2cells, DG_NUM_FACES * DG_NPF, "double", OP_INC));
...
void DGMesh3D::div(op_dat u, op_dat v, op_dat w, op_dat res) {
  ...
  op_par_loop(div_3d, "div_3d", cells,
              ...
              op_arg_dat(sx, -1, OP_ID, 1, "double", OP_READ),
              op_arg_dat(tx, -1, OP_ID, 1, "double", OP_READ),
              op_arg_dat(res, -1, OP_ID, DG_NP, "double", OP_INC));
...
void DGMesh3D::div_with_central_flux(op_dat u, op_dat v, op_dat w, op_dat res) {
  ...
  op_par_loop(div_3d_central_flux, "div_3d_central_flux", faces,
              ...
              op_arg_dat(fscale, -1, OP_ID, 2, "double", OP_READ),
              op_arg_dat(u, -2, face2cells, DG_NP, "double", OP_READ),
              op_arg_dat(v, -2, face2cells, DG_NP, "double", OP_READ),
              op_arg_dat(w, -2, face2cells, DG_NP, "double", OP_READ),
              op_arg_dat(op_tmp_npf[0], -2, face2cells, DG_NUM_FACES * DG_NPF, "double", OP_INC));
...
void DGMesh3D::curl(op_dat u, op_dat v, op_dat w,
  ...
  op_par_loop(curl0_3d, "curl0_3d", cells,
              ...
              op_arg_dat(sz, -1, OP_ID, 1, "double", OP_READ),
              op_arg_dat(tz, -1, OP_ID, 1, "double", OP_READ),
              op_arg_dat(resy, -1, OP_ID, DG_NP, "double", OP_WRITE),
              op_arg_dat(resz, -1, OP_ID, DG_NP, "double", OP_WRITE));
  ...
  op_par_loop(curl1_3d, "curl1_3d", cells,
              ...
              op_arg_dat(sz, -1, OP_ID, 1, "double", OP_READ),
              op_arg_dat(tz, -1, OP_ID, 1, "double", OP_READ),
              op_arg_dat(resx, -1, OP_ID, DG_NP, "double", OP_WRITE),
              op_arg_dat(resz, -1, OP_ID, DG_NP, "double", OP_RW));
  ...
  op_par_loop(curl2_3d, "curl2_3d", cells,
              ...
              op_arg_dat(sy, -1, OP_ID, 1, "double", OP_READ),
              op_arg_dat(ty, -1, OP_ID, 1, "double", OP_READ),
              op_arg_dat(resx, -1, OP_ID, DG_NP, "double", OP_RW),
              op_arg_dat(resy, -1, OP_ID, DG_NP, "double", OP_RW));
}
...
void DGMesh3D::mass(op_dat u) {
  op_par_loop(mass, "mass", cells,
              ...
              op_arg_dat(J, -1, OP_ID, 1, "double", OP_READ),
              op_arg_dat(u, -1, OP_ID, DG_NP, "double", OP_RW));
}

void DGMesh3D::inv_mass(op_dat u) {
  op_par_loop(inv_mass, "inv_mass", cells,
              op_arg_gbl(constants->get_mat_ptr(DGConstants::INV_MASS), DG_ORDER * DG_NP * DG_NP, "double", OP_READ),
              op_arg_dat(J, -1, OP_ID, 1, "double", OP_READ),
              op_arg_dat(u, -1, OP_ID, DG_NP, "double", OP_RW));
}