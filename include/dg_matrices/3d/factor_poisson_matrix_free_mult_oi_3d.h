#ifndef __DG_FACTOR_POISSON_MATRIX_FREE_MULT_OI_3D_H
#define __DG_FACTOR_POISSON_MATRIX_FREE_MULT_OI_3D_H

#include "op_seq.h"
#include "dg_mesh/dg_mesh_3d.h"
#include "poisson_matrix_free_mult_3d.h"

class FactorPoissonMatrixFreeMultOI3D : public PoissonMatrixFreeMult3D {
public:
  FactorPoissonMatrixFreeMultOI3D(DGMesh3D *m);
...
protected:
  op_dat mat_free_factor, mat_free_factor_copy, mat_free_gtau, mat_free_factor_copy_sp, mat_free_factor_oi, mat_free_factor_surf_oi;
