#ifndef __DG_FACTOR_POISSON_MATRIX_FREE_DIAG_OI_2D_H
#define __DG_FACTOR_POISSON_MATRIX_FREE_DIAG_OI_2D_H

#include "op_seq.h"
#include "dg_mesh/dg_mesh_2d.h"
#include "../poisson_matrix_free_diag.h"
#include "factor_poisson_matrix_free_mult_oi_2d.h"

class FactorPoissonMatrixFreeDiagOI2D : public PoissonMatrixFreeDiag, public FactorPoissonMatrixFreeMultOI2D {
public:
  FactorPoissonMatrixFreeDiagOI2D(DGMesh2D *m);
