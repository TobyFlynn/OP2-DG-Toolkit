...
sed -i "1i #include \"dg_compiler_defs.h\"" cuda/dg_tookit_kernels.cu
sed -i "1i #include \"dg_compiler_defs.h\"" hip/dg_tookit_kernels.cpp
...
sed -i "2i #include \"dg_global_constants/dg_mat_constants_2d.h\"" cuda/dg_tookit_kernels.cu
sed -i "2i #include \"dg_global_constants/dg_mat_constants_2d.h\"" hip/dg_tookit_kernels.cpp
...
sed -i "3i #include \"cblas.h\"" openmp/dg_tookit_kernels.cpp
sed -i "3i #include \"cblas.h\"" seq/dg_tookit_seqkernels.cpp
...
sed -i "1i #include \"omp.h\"" openmp/dg_tookit_kernels.cpp
sed -i "1i #include \"dg_compiler_defs.h\"" seq/dg_tookit_seqkernels.cpp
sed -i "2i #include \"dg_global_constants/dg_mat_constants_3d.h\"" cuda/dg_tookit_kernels.cu
sed -i "2i #include \"dg_global_constants/dg_mat_constants_3d.h\"" hip/dg_tookit_kernels.cpp
